...
internal class NetworkingPeer : LoadbalancingPeer, IPhotonPeerListener
{
    ...
    internal Hashtable SendInstantiate(string prefabName, Vector3 position, Quaternion rotation, int group, int[] viewIDs, object[] data, bool isGlobaLogicObject)
    {
        ...
        options.CachingOption = (isGlobaLogicObject) ? EventCaching.AddToRoomCacheGlobal : EventCaching.AddToRoomCache;
